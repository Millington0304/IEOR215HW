...
CREATE TABLE AccountRevenue (
    TRID INT,          -- Foreign key to Revenue
...
CREATE TABLE AccountExpenditure (
    TRID INT,          -- Foreign key to Expenditure
    AccID INT,         -- Foreign key to BankAccount
    Amount DECIMAL(10, 2) NOT NULL,
    PRIMARY KEY (TRID, AccID),
...
CREATE TABLE ExpenditurePays (
    TRID INT NOT NULL,          -- Foreign key to Expenditure
...
CREATE TABLE Purchase (
    ...
    TRID INT NOT NULL,          -- Foreign key to Revenue
